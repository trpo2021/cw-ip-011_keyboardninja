...
//Следующие два теста проверяют, что будет, если ввести mode и difficulty вне их
//значений. Делаю через equal, так как не работает null. ПОэттому ввел константу
//k =1
